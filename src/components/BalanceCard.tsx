...
export function BalanceCard({
  ...
  return <Card className="border-2 border-bank-gold/30 shadow-xl bg-card">
      ...
      <CardContent>
        ...
        <div className="border-t border-border pt-4 mt-4">
          <p className="text-xs text-muted-foreground text-center italic">Terms: $0.10 per "one sec" occurrence. No refunds. Paid Annually.</p>
        </div>
      </CardContent>
    </Card>;
}